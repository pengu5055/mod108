...
ax[0].text(0.05, 0.9, avg_steps_text, transform=ax[0].transAxes,
...
ax[1].imshow(end_energy, cmap=cm, aspect="auto",
                extent=[anneal_values[0], anneal_values[-1], T_values[-1], T_values[0]])

ax[1].set_xlabel("Annealing Rate")
ax[1].set_ylabel("Temperature")
ax[1].set_title("Final Energy")
