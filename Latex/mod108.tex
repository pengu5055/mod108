...
optimizing such a lattice with the same Hamiltonian is displayed in Figure (\ref{fig:ising-demo-3/2}).

\begin{figure}[H]
    \centering
    % \includegraphics[width=.95\textwidth]{../IsingModel/Images/ising-demo-3-2.png}
    \caption{Initial and final states of the Ising model lattice with $s=3/2$ particles.}
    \label{fig:ising-demo-3/2}
\end{figure}
