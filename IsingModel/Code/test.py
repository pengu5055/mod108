...
m = Metropolis2((500, 500), 1)
m.temperature = 0.00001
m.MAX_ITER = 10000000
...
plt.suptitle(f"Ising: $500^2$ spins, $T = {m.temperature:.2e}, ${m.MAX_ITER:.2e} iterations")
plt.tight_layout()
plt.savefig("./IsingModel/Images/isingmodel-random-test.png", dpi=400)
plt.show()
